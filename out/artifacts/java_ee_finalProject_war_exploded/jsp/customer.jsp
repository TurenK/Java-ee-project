...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="customer.jsp">BOOT客户管理系统 v2.0</a>
		</div>
		<!-- /.navbar-header -->

		<ul class="nav navbar-top-links navbar-right">
			<li class="dropdown"><a class="dropdown-toggle"
				data-toggle="dropdown" href="#"> <span class="fa fa-envelope fa-fw" style="font-style: italic;"></span>
			...
			<!-- /.dropdown -->
			<li class="dropdown"><a class="dropdown-toggle"
				data-toggle="dropdown" href="#"> <span class="fa fa-tasks fa-fw" style="font-style: italic;"></span>
					<span class="fa fa-caret-down" style="font-style: italic;"></span>
			</a>
			...
			<!-- /.dropdown -->
			<li class="dropdown"><a class="dropdown-toggle"
				data-toggle="dropdown" href="#"> <span class="fa fa-bell fa-fw" style="font-style: italic;"></span>
					<span class="fa fa-caret-down" style="font-style: italic;"></span>
			</a>
				<ul class="dropdown-menu dropdown-alerts">
					<li><a href="#">
							<div>
								<span class="fa fa-comment fa-fw" style="font-style: italic;"></span> 新回复 <span
					...
					<li><a href="#">
							<div>
								<span class="fa fa-envelope fa-fw" style="font-style: italic;"></span> 新消息 <span
									class="pull-right text-muted small">4分钟之前</span>
							</div>
					</a></li>
					<li class="divider"></li>
					<li><a href="#">
							<div>
								<span class="fa fa-tasks fa-fw" style="font-style: italic;"></span> 新任务 <span
									class="pull-right text-muted small">4分钟之前</span>
							</div>
					</a></li>
					<li class="divider"></li>
					<li><a href="#">
							<div>
								<span class="fa fa-upload fa-fw" style="font-style: italic;"></span> 服务器重启 <span
									class="pull-right text-muted small">4分钟之前</span>
							</div>
					</a></li>
					<li class="divider"></li>
			...
			<!-- /.dropdown -->
			<li class="dropdown"><a class="dropdown-toggle"
				data-toggle="dropdown" href="#"> <span class="fa fa-user fa-fw" style="font-style: italic;"></span>
					<span class="fa fa-caret-down" style="font-style: italic;"></span>
			</a>
				<ul class="dropdown-menu dropdown-user">
					<li><a href="#"><span class="fa fa-user fa-fw" style="font-style: italic;"></span> 用户设置</a></li>
					<li><a href="#"><span class="fa fa-gear fa-fw" style="font-style: italic;"></span> 系统设置</a></li>
					<li class="divider"></li>
					<li><a href="#"><span class="fa fa-sign-out fa-fw" style="font-style: italic;"></span>
							退出登录</a></li>
				</ul> <!-- /.dropdown-user --></li>
			<!-- /.dropdown -->
		</ul>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="${pageContext.request.contextPath}/customer/list.do" class="active"><span
                            class="fa fa-edit fa-fw" style="font-style: italic;"></span> 客户管理</a></li>
					<li><a href="salevisit.action"><span
                            class="fa fa-dashboard fa-fw" style="font-style: italic;"></span> 客户拜访</a></li>
				</ul>
			</div>
			<!-- /.sidebar-collapse -->
		</div>
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath}/customer/list.do" method="post">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<ssmdemo:page url="${pageContext.request.contextPath }/customer/list.do" />
						</div>
					</div>
					<!-- /.panel -->
				</div>
	...
	<script src="<%=basePath%>js/metisMenu.min.js" type="text/javascript"></script>
	...
	<script src="<%=basePath%>js/sb-admin-2.js" type="text/javascript"></script>
